...
// -- BOOTSTRAP THEME BORDER FOR FOOTER use 'border-top' = ON or 'NULL' = OFF --
const CON_FOOTER_BORDER = 'border-top'; 

// -- BOOTSTRAP THEME COLOUR FOR FIXED FOOTER use 'dark' or 'light' --
const CON_FOOTER_COLOUR = 'light';

// -- BOOTSTRAP FOOTER TYPE use 'fixed','basic', 'two-col', 'three-col', four-col', 'none' --
...
// -- USE BOOTSTRAP ALERT STYLES  https://getbootstrap.com/docs/4.0/components/alerts/ -- 
const CON_ALERT_MESSAGE_STYLE = 'success'; 

// -- MESSAGE TEXT 
const CON_ALERT_MESSAGE_TEXT = '<i class="fa fa-warning"></i> TEST MESSAGE';

// -- TURN 'on' OR 'off' SITE WIDE ALERT MESSAGE FOR LOCKED PAGES ONLY
const CON_ALERT_STATE_LOCKED = 'off';

// -- USE BOOTSTRAP ALERT STYLES  https://getbootstrap.com/docs/4.0/components/alerts/ -- 
const CON_ALERT_MESSAGE_STYLE_LOCKED = 'danger'; 

// -- MESSAGE TEXT 
const CON_ALERT_MESSAGE_TEXT_LOCKED = '<i class="fa fa-warning"></i> TEST MESSAGE LOCKED';

// -- BOOTSTRAP FLUID BEHAVIOR Turn on = '-fluid' or OFF = '' -- 
const CON_DIV_STYLE = '';
